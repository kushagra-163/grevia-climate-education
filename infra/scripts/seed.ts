...
export const seedDatabase = async () => {
  ...
  const rawQuestionsData = [
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'beginner',
      options: ["Plastic recycling","Solar power installation","Burning fossil fuels for energy","Organic farming"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'beginner',
      options: ["Tidal frequency","Submarine sound velocity","Salt crystallization rates","Sea surface temperature and global sea level rise"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'intermediate',
      options: ["Thermohaline slowdown","The Ice-Albedo Feedback Loop","Coral calcification","Aerosol masking"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'intermediate',
      options: ["Industrial chemical spills","Plastic waste breakdown","Seawater absorbing excess atmospheric CO2 to form carbonic acid","Rising ocean temperatures"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'intermediate',
      options: ["Kepler orbits","Solar flare oscillations","Lunar precession tides","Milankovitch Cycles"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'advanced',
      options: ["Stratospheric ozone collapse","Permafrost thawing feedback","Oceanic upwelling inversion","Mantle convective release"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'advanced',
      options: ["The Humboldt Current","The Kuroshio Extension","The Atlantic Meridional Overturning Circulation (AMOC)","The Antarctic Circumpolar Current"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'climate_science', level: 'advanced',
      options: ["Short-term weather forecasting vectors","Solar panel manufacturing quotas","Nuclear waste containment protocols","Integrated socio-economic narratives combining mitigation, adaptation, and demographic trends"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      options: ["Electricity generated by rooftop wind chimes","Power consumed by electronics while turned off or in standby mode","Static electricity from carpet friction","Energy lost in high-voltage lines"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'energy', level: 'beginner',
      options: ["Incandescent bulbs","Halogen spotlights","Light Emitting Diode (LED)","Kerosene lamps"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'energy', level: 'beginner',
      options: ["Galvanic barometer","Thermal multimeter","Seismograph","Smart Electric Meter"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'energy', level: 'beginner',
      options: ["Increasing power plant capacity","Reducing energy consumption through behavioral changes and reduced usage","Importing electricity from neighboring countries","Converting coal directly to gas"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      options: ["Combines coal and natural gas in one furnace","Captures waste heat from power generation for space or process heating","Uses solar heat to split water molecules","Stores heat in lithium batteries"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'energy', level: 'intermediate',
      options: ["The maximum peak power during hot summer afternoons","Electricity generated exclusively by rooftop solar","The minimum continuous level of demand on an electrical grid","Emergency backup generator capacity"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'energy', level: 'intermediate',
      options: ["Thermal enthalpy index","Carnot cycle quotient","Volt-ampere reactance","Energy Return on Investment (EROI)"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'energy', level: 'intermediate',
      options: ["Automatically shutting off power to residential areas","Encouraging consumers to shift energy usage away from peak demand hours","Increasing fossil fuel subsidies","Mandating constant industrial operation"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      options: ["Single-phase Alternating Current","High-Voltage Direct Current (HVDC)","Superconducting fluid pipes","Low-voltage distribution lines"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'energy', level: 'advanced',
      options: ["Spot trading of solar panels","Taxes on battery storage","Payments made to power generators to ensure standby availability for peak grid reliability","Export tariffs on crude oil"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'energy', level: 'advanced',
      options: ["Joule coefficient","Ampere rating","Kelvin modulus","R-value"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'energy', level: 'advanced',
      options: ["Installing office ceiling fans","Replacing high-temperature fossil combustion in steel and cement with green electricity and hydrogen","Switching to diesel boilers","Insulating residential attics"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      options: ["Geothermal steam","Wind currents","Sunlight (photons)","Tidal gravity"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'beginner',
      options: ["Ocean wave swells","River currents","Volcanic steam","Atmospheric wind currents"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'beginner',
      options: ["By boiling river water with coal","By channeling falling water through hydraulic turbines","By splitting water molecules into hydrogen","By evaporating reservoir water"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'beginner',
      options: ["Crude oil refining","Uranium isotopes","Organic plant and agricultural materials","Synthetic plastics"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      options: ["Betz Limit (59.3%)","Carnot Limit (100%)","The Shockley-Queisser Limit (~33.7%)","Hubbert Limit (50%)"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'intermediate',
      options: ["Ohm Law","First Law of Thermodynamics","Kepler Law","Betz Law (59.3% maximum efficiency)"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'intermediate',
      options: ["The physical size of the power generator","The ratio of actual electricity generated over a period to its maximum potential output at full capacity","The total financial cost per megawatt","The number of operational staff employed"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'intermediate',
      options: ["CSP converts light directly to DC current","CSP works only under heavy cloud cover","CSP uses mirrors to focus sunlight to heat a working fluid, driving a steam turbine","CSP uses wind currents to cool panels"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      options: ["Alkaline Liquid Siphon","Steam Methane Reforming","Proton Exchange Membrane (PEM) Electrolysis","Fischer-Tropsch Synthesis"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'advanced',
      options: ["Gallium Arsenide Monoliths","Cadmium Telluride Thin-Films","Copper Indium Selenium Panels","Perovskite-Silicon Tandem Cells"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'advanced',
      options: ["Voltage collapse","Renewable Curtailment","Frequency runaway","Reactive impedance boost"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'renewable_energy', level: 'advanced',
      options: ["Lithium Cobalt Oxide (LCO)","Nickel Manganese Cobalt (NMC)","Lithium Iron Phosphate (LFP)","Lead Acid Gel"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      options: ["Recycle, Burn, Discard","Reuse, Incinerate, Bury","Dump, Sort, Recover","Reduce, Reuse, Recycle"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'waste', level: 'beginner',
      options: ["It dissolves instantly in rainwater","It persists for centuries, breaking down into toxic microplastics that harm wildlife","It absorbs atmospheric carbon dioxide","It accelerates plant growth"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'waste', level: 'beginner',
      options: ["Incineration","Pyrolysis","Composting","Vitrification"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'waste', level: 'beginner',
      options: ["Bags dissolve into sea salt","Bags warm the ocean water","Bags increase ocean oxygen levels","Animals mistake floating bags for jellyfish or food, causing internal blockages"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      options: ["Pay-as-you-throw pricing","Landfill tax exemptions","Consumer duty mandate","Extended Producer Responsibility (EPR)"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'waste', level: 'intermediate',
      options: ["Open pit combustion","Waste Incineration with Energy Recovery (EfW)","Aerobic digestion","Hydro-cracking"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'waste', level: 'intermediate',
      options: ["Electronics melt too easily","Electronics contain no metals","Electronics contain complex mixtures of toxic heavy metals, flame retardants, and valuable trace elements bonded together","Electronics biodegrade too quickly"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'waste', level: 'intermediate',
      options: ["They dissolve instantly in hot water","They emit toxic sulfur when touched","They cannot hold dry goods","They require high-temperature industrial composting facilities and will not break down quickly in home compost or oceans"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      options: ["Cradle-to-Grave manufacturing","Linear extraction modeling","Planned obsolescence protocols","Cradle-to-Cradle (C2C) Design"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'waste', level: 'advanced',
      options: ["Sintering","Pyrolysis","Calcination","Flocculation"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'waste', level: 'advanced',
      options: ["Kuroshio index","Thermal expansion factor","Material Intensity Per Service (MIPS)","Carbon payback period"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'waste', level: 'advanced',
      options: ["It encourages modular repair","It eliminates manufacturing waste","It lowers raw material mining","It intentionally shortens product lifespan to force replacement sales, accelerating resource depletion and e-waste"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'water', level: 'beginner',
      options: ["Sewage water from toilets","Relatively clean wastewater from showers, sinks, and laundry","Industrial chemical runoff","Ocean saltwater"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'water', level: 'beginner',
      options: ["Flood irrigation","High-pressure spray cannons","Drip Irrigation","Canal flooding"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'water', level: 'beginner',
      options: ["High-volume garden hoses","Open drain traps","Single-flush 5-gallon tanks","Low-flow aerated showerheads and dual-flush toilets"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'water', level: 'intermediate',
      options: ["Hydraulic conductivity","Virtual Water Content (Water Footprint)","Osmotic potential","Turbidity index"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'water', level: 'intermediate',
      options: ["Freshwater produced is too salty","Desalination creates methane gas","High energy consumption and disposal of concentrated toxic brine back into ocean ecosystems","Desalination causes earthquakes"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'water', level: 'intermediate',
      options: ["They collect water in underground diesel tanks","They evaporate rain before it hits the ground","They block all rain infiltration","They allow rainwater to soak into the soil, recharging groundwater and reducing flash runoff floods"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'water', level: 'advanced',
      options: ["NF rejects all water molecules","RO pores (< 0.001 microns) reject monovalent ions like Na+, while NF rejects divalent ions","RO allows bacteria to pass","NF requires high temperatures"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'water', level: 'advanced',
      options: ["Privatizing all freshwater springs","Damming all major rivers","A holistic framework coordinating water, land, and economic development to maximize equitable welfare without compromising ecosystems","Diverting rivers across desert continents"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'water', level: 'advanced',
      options: ["It doubles winter snow depth","It prevents all spring runoff","It locks water permanently in ice","It shifts winter snow to rain and causes earlier spring melt, reducing summer river availability"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      options: ["Biomass index","Biodiversity","Monoculture","Biosphere radius"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'beginner',
      options: ["Wildlife photography","Binocular observations","Habitat destruction and land conversion","Eco-tourism hikes"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'beginner',
      options: ["Trees grow inside underwater corals","They produce rainforest fruit underwater","They exist only in tropical rivers","They harbor over 25% of all ocean marine life despite covering under 1% of the seafloor"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'beginner',
      options: ["By filtering agricultural irrigation water","By pollinating crops responsible for fruits, vegetables, and nuts","By aerating underground aquifers","By neutralizing pesticide runoff"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      options: ["The most abundant animal species in a forest","A species whose presence exerts strong disproportionate control on maintaining ecosystem structure","An invasive plant species","A species raised exclusively in captivity"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'intermediate',
      options: ["Mangroves heat shallow ocean bays","Mangroves push storm clouds back to sea","Dense root systems absorb wave energy, preventing coastal erosion and protecting inland communities","Mangroves produce sea salt"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'intermediate',
      options: ["Coral spawning","Hydrothermal venting","Sub-surface upwelling","Coral Bleaching"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'intermediate',
      options: ["Gross Domestic Product (GDP)","Ecosystem Services Valuation","Resource depletion credit","Carbon tax refund"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      options: ["Competitive exclusion principle","Trophic Cascade","Ecological succession","Biomagnification peak"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'advanced',
      options: ["Instant glaciation","Conversion into an ocean bay","Dieback transition from rainforest to degraded savanna","Permanent cloud cover formation"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'advanced',
      options: ["The Kyoto Protocol","The Paris Accord Article 6","The RAMSAR wetland directive","The 30x30 Target (Kunming-Montreal Global Biodiversity Framework)"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'biodiversity', level: 'advanced',
      options: ["Plastics dissolve into seawater nutrients","Lipophilic toxic chemicals adsorb onto microplastics, concentrating in higher apex marine predators as small prey are consumed","Apex predators absorb plastics through gills","Microplastics evaporate into air"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      options: ["Buses do not use any energy","Cars use more air than buses","Public transit carries many passengers at once, lowering greenhouse gas emissions per person-mile","Trains generate oxygen as they move"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'beginner',
      options: ["Diesel motorcycles","Gasoline scooters","Idling idling sports cars","Active Transportation (Walking and Bicycling)"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'beginner',
      options: ["Proper tire pressure inflation","Vehicle Idling (leaving the engine running while stopped)","Using cruise control on highways","Driving at steady speeds"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'beginner',
      options: ["It doubles car engine speed","It eliminates the need for roads","It reduces the total number of cars on the road, decreasing traffic congestion and emissions","It converts exhaust to steam"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      options: ["Hydraulic friction braking","Exhaust heat recycling","Regenerative Braking","Inductive road coupling"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'intermediate',
      options: ["High-occupancy toll lanes","Suburban bypass ring roads","Park-and-ride commuter lots","Bus Rapid Transit (BRT)"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'intermediate',
      options: ["By banning bicycles from downtown","By restricting or charging fees to high-polluting vehicles entering designated urban areas","By subsidizing diesel fuel for trucks","By eliminating parking meters"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'intermediate',
      options: ["Shipment from dealership","Tire rubber synthesis","Battery raw material extraction and cell manufacturing","Windshield glass molding"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      options: ["Compressed Compressed Natural Gas","Lithium battery packs only","Green Ammonia (NH3) / E-Methanol","Aviation kerosene"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'advanced',
      options: ["Inductive static pads","DC fast charging","Substation step-down transformation","Vehicle-to-Grid (V2G) Bi-directional Charging"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'advanced',
      options: ["Exhaust soot agglomerates","Tire and brake wear friction particles","Radiator coolant mist","Windshield wiper fluid spray"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'transportation', level: 'advanced',
      options: ["Commute velocity quotient","Induced demand multiplier","Modal Split (Modal Share)","Traffic queuing index"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      options: ["Plants do not require sunlight to grow","Animals absorb carbon dioxide","Plant foods contain no water","Plant agriculture requires significantly less land, water, and energy than raising livestock"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'beginner',
      options: ["Boiling hot cycle (90°C)","Cold water wash (30°C / Cold cycle)","Warm steam wash","Pre-heated sanitized wash"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'beginner',
      options: ["Buying every new gadget upon release","Purchasing fast fashion weekly","Making intentional purchasing decisions that favor durable, ethically made, and low-impact products","Using disposable paper plates daily"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'beginner',
      options: ["Disposable paper sacks discarded after one use","Thin plastic produce bags","Single-use foil wraps","Reusable canvas or cloth tote bags"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      options: ["Using too much organic cotton","Manufacturing clothes that last too long","Employing local tailors","Mass producing low-quality synthetic garments that drive massive textile waste, water pollution, and microplastic shed"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'intermediate',
      options: ["Basal metabolic rate","Personal Carbon Footprint (in metric tons CO2e)","Ecological trophic score","Consumer price index"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'intermediate',
      options: ["They generate supplementary solar heat","They lower outside humidity","They automatically adjust indoor temperatures based on occupancy schedules and nighttime setbacks","They replace window glass"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'intermediate',
      options: ["Rooftop netting","Off-grid diesel cooperatives","Individual battery leasing","Community Solar (Shared Solar Subscriptions)"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      options: ["Direct fuel burned in company vehicles (Scope 1)","Purchased grid electricity (Scope 2)","Emissions from breathing","All indirect supply chain emissions across product extraction, material processing, transport, and consumer end-of-use"],
      correctAnswer: 'D',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'advanced',
      options: ["The Doughnut Economics core index","The Planetary Boundaries Framework (Stockholm Resilience Centre)","The IPCC Scenario matrix","The UN SDG 17 points"],
      correctAnswer: 'B',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'advanced',
      options: ["Material Safety Data Sheet (MSDS)","Environmental Impact Statement (EIS)","Life Cycle Assessment (LCA - ISO 14040/44)","Supply Chain Audit"],
      correctAnswer: 'C',
    ...
    },
    {
      ...
      topic: 'sustainable_living', level: 'advanced',
      options: ["By levying heavy criminal fines","By rationing grocery purchases","By banning public advertising","By altering default options to eco-friendly choices (e.g. green energy opt-out defaults) without restricting consumer freedom"],
      correctAnswer: 'D',
  ...
  // Upsert questions cleanly without wiping QuizAttempt or user data
  ...
  for (const q of rawQuestionsData) {
    ...
    if (normalizedSeen.has(normKey)) {
      ...
      answerDist[q.correctAnswer.toUpperCase()] = (answerDist[q.correctAnswer.toUpperCase()] || 0) + 1;
    }
  }
  ...
  Object.entries(answerDist).forEach(([letter, count]) => {
    console.log(`  - Option ${letter}: ${count} (${((count / uniqueCount) * 100).toFixed(1)}%)`);
  });
  console.log('----------------------------------------------------');
